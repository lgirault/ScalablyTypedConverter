...
open class LoaderResource protected () extends StObject {
  ...
  var blob: js.UndefOr[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Blob */ Any
  ] = js.native
  ...
  /**
    ...
    * @member {Error}
    */
  var error: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Error */ Any = js.native
  ...
  /**
    ...
    * @readonly
    */
  var xhr: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify XMLHttpRequest */ Any = js.native
