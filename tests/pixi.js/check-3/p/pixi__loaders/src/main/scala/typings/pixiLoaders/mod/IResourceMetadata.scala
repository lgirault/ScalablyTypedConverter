...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GlobalMixins.IResourceMetadata * / any */ trait IResourceMetadata
  extends StObject
  ...
  var loadElement: js.UndefOr[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any
  ] = js.undefined
...
object IResourceMetadata {
  ...
  extension [Self <: IResourceMetadata](x: Self) {
    ...
    inline def setLoadElement(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any
    ): Self = StObject.set(x, "loadElement", value.asInstanceOf[js.Any])
