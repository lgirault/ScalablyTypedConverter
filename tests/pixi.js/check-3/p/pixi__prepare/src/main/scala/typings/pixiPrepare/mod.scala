...
object mod {
  ...
  open class BasePrepare protected () extends StObject {
    ...
    /**
      ...
      */
    @JSName("upload")
    def upload_Unit(): Unit = js.native
    @JSName("upload")
    def upload_Unit(item: BaseTexture[Resource, IAutoDetectOptions]): Unit = js.native
    @JSName("upload")
    def upload_Unit(item: Texture[Resource]): Unit = js.native
    @JSName("upload")
    def upload_Unit(item: Container[DisplayObject]): Unit = js.native
    @JSName("upload")
    def upload_Unit(item: IDisplayObjectExtended): Unit = js.native
  }
