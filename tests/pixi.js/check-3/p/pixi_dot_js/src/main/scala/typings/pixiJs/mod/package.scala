...
): js.Array[typings.pixiCompressedTextures.mod.CompressedTextureResource] = ^.asInstanceOf[js.Dynamic].applyDynamic("parseDDS")(arrayBuffer.asInstanceOf[js.Any]).asInstanceOf[js.Array[typings.pixiCompressedTextures.mod.CompressedTextureResource]]
