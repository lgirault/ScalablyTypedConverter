...
import typings.pixiJs.pixiJsNumbers.`-1`
import typings.pixiJs.pixiJsNumbers.`0`
import typings.pixiJs.pixiJsNumbers.`1`
...
object utils {
  ...
  inline def createIndicesForQuads(
    size: Double,
    outBuffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint16Array */ Any
