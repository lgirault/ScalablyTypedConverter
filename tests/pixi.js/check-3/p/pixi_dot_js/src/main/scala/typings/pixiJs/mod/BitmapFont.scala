...
object BitmapFont {
  ...
  inline def from(name: String, textStyle: Partial[ITextStyle]): typings.pixiTextBitmap.mod.BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(name.asInstanceOf[js.Any], textStyle.asInstanceOf[js.Any])).asInstanceOf[typings.pixiTextBitmap.mod.BitmapFont]
  inline def from(name: String, textStyle: Partial[ITextStyle], options: IBitmapFontOptions): typings.pixiTextBitmap.mod.BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(name.asInstanceOf[js.Any], textStyle.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.pixiTextBitmap.mod.BitmapFont]
