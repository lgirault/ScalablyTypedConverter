...
object Texture {
  ...
  inline def fromBuffer(
    buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any,
    width: Double,
    height: Double
  ): typings.pixiCore.mod.Texture[typings.pixiCore.mod.BufferResource] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromBuffer")(buffer.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[typings.pixiCore.mod.Texture[typings.pixiCore.mod.BufferResource]]
  inline def fromBuffer(
    buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any,
    width: Double,
    height: Double,
  ...
  inline def fromLoader[R /* <: typings.pixiCore.mod.Resource */](source: String, imageUrl: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: typings.pixiCore.mod.Resource */](source: String, imageUrl: String, name: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: typings.pixiCore.mod.Resource */](source: String, imageUrl: String, name: String, options: IBaseTextureOptions[Any]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  /**
    ...
    */
  inline def fromLoader[R /* <: typings.pixiCore.mod.Resource */](
  ...
  inline def fromLoader[R /* <: typings.pixiCore.mod.Resource */](source: HTMLCanvasElement, imageUrl: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: typings.pixiCore.mod.Resource */](source: HTMLCanvasElement, imageUrl: String, name: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  /**
    ...
    */
  inline def fromURL[R /* <: typings.pixiCore.mod.Resource */, RO](url: String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def fromURL[R /* <: typings.pixiCore.mod.Resource */, RO](url: String, options: IBaseTextureOptions[RO]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromURL[R /* <: typings.pixiCore.mod.Resource */, RO](url: js.Array[String]): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def fromURL[R /* <: typings.pixiCore.mod.Resource */, RO](url: js.Array[String], options: IBaseTextureOptions[RO]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
