...
object graphicsUtils {
  ...
  @JSImport("pixi.js", "graphicsUtils.ArcUtilsCls")
  @js.native
  open class ArcUtilsCls ()
    extends typings.pixiGraphics.mod.graphicsUtils.ArcUtilsCls
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("pixi.js", "graphicsUtils.BatchPartCls")
  @js.native
  open class BatchPartCls ()
    extends typings.pixiGraphics.mod.graphicsUtils.BatchPartCls
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("pixi.js", "graphicsUtils.BezierUtilsCls")
  @js.native
  open class BezierUtilsCls ()
    extends typings.pixiGraphics.mod.graphicsUtils.BezierUtilsCls
  ...
  @js.native
  def FILL_COMMANDS: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Record<SHAPES, IShapeBuildCommand> */ Any = js.native
  inline def FILL_COMMANDS_=(
    x: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Record<SHAPES, IShapeBuildCommand> */ Any
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FILL_COMMANDS")(x.asInstanceOf[js.Any])
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("pixi.js", "graphicsUtils.QuadraticUtilsCls")
  @js.native
  open class QuadraticUtilsCls ()
    extends typings.pixiGraphics.mod.graphicsUtils.QuadraticUtilsCls
