...
import typings.pixiText.mod.ITextStyle
...
object BitmapFont {
  ...
  inline def from(name: String, textStyle: Partial[ITextStyle]): BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(name.asInstanceOf[js.Any], textStyle.asInstanceOf[js.Any])).asInstanceOf[BitmapFont]
  inline def from(name: String, textStyle: Partial[ITextStyle], options: IBitmapFontOptions): BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(name.asInstanceOf[js.Any], textStyle.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[BitmapFont]
  ...
  inline def install(
    data: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify XMLDocument */ Any,
    textures: js.Array[Texture[Resource]]
  ): BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("install")(data.asInstanceOf[js.Any], textures.asInstanceOf[js.Any])).asInstanceOf[BitmapFont]
  inline def install(
    data: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify XMLDocument */ Any,
    textures: js.Array[Texture[Resource]],
    ownsTextures: Boolean
  ): BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("install")(data.asInstanceOf[js.Any], textures.asInstanceOf[js.Any], ownsTextures.asInstanceOf[js.Any])).asInstanceOf[BitmapFont]
  inline def install(
    data: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify XMLDocument */ Any,
