...
object anon {
  ...
  trait Data extends StObject {
    ...
    var data: js.UndefOr[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ImageData */ Any
      ] = js.undefined
  ...
  object Data {
    ...
    extension [Self <: Data](x: Self) {
      ...
      inline def setData(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ImageData */ Any
