...
object mod {
  ...
  open class ParticleContainer () extends Container[Sprite] {
    ...
    var tintRgb: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any = js.native
  ...
  trait ParticleBuffer extends StObject {
    ...
    var dynamicData: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any
    
    var dynamicDataUint32: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint32Array */ Any
    ...
    var staticData: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any
    
    var staticDataUint32: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint32Array */ Any
  ...
  object ParticleBuffer {
    ...
    inline def apply(
      ...
      dynamicData: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any,
      dynamicDataUint32: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint32Array */ Any,
      ...
      size: Any,
      staticBuffer: Buffer,
      staticData: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any,
      staticDataUint32: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint32Array */ Any,
    ...
    extension [Self <: ParticleBuffer](x: Self) {
      ...
      inline def setDynamicData(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any
      ): Self = StObject.set(x, "dynamicData", value.asInstanceOf[js.Any])
      
      inline def setDynamicDataUint32(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint32Array */ Any
      ): Self = StObject.set(x, "dynamicDataUint32", value.asInstanceOf[js.Any])
      ...
      inline def setStaticData(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any
      ): Self = StObject.set(x, "staticData", value.asInstanceOf[js.Any])
      
      inline def setStaticDataUint32(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint32Array */ Any
      ): Self = StObject.set(x, "staticDataUint32", value.asInstanceOf[js.Any])
