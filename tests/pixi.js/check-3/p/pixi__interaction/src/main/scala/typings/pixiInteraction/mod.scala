...
object mod {
  ...
  open class InteractionData () extends StObject {
    ...
    /**
      ...
      */
    def copyEvent(
      event: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Touch */ Any) | InteractivePointerEvent
    ): Unit = js.native
  ...
  open class InteractionManager protected ()
    ...
    /**
      ...
      */
    var cursorStyles: Dict[
        String | (js.Function1[/* mode */ String, Unit]) | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CSSStyleDeclaration */ Any)
      ] = js.native
    ...
    /* protected */ var interactionDOMElement: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLElement */ Any = js.native
    ...
    def setTargetElement(
      element: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLElement */ Any
    ): Unit = js.native
    def setTargetElement(
      element: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLElement */ Any,
      resolution: Double
  ...
  */
  ...
  type InteractivePointerEvent = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PointerEvent */ Any
