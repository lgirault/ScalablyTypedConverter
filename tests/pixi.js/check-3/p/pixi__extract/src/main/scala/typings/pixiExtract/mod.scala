...
object mod {
  ...
  object Extract {
    ...
    inline def arrayPostDivide(
      pixels: js.Array[Double],
      out: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8Array */ /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8ClampedArray */ Any
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("arrayPostDivide")(pixels.asInstanceOf[js.Any], out.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def arrayPostDivide(
      pixels: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8Array */ /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8ClampedArray */ Any,
      out: js.Array[Double]
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("arrayPostDivide")(pixels.asInstanceOf[js.Any], out.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def arrayPostDivide(
      pixels: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8Array */ /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8ClampedArray */ Any,
  ...
  trait Extract2
    ...
    def image(target: RenderTexture): Any = js.native
    def image(target: RenderTexture, format: String): Any = js.native
    def image(target: RenderTexture, format: String, quality: Double): Any = js.native
    def image(target: RenderTexture, format: Unit, quality: Double): Any = js.native
    /**
      ...
      */
    def image(target: DisplayObject): Any = js.native
    def image(target: DisplayObject, format: String): Any = js.native
    def image(target: DisplayObject, format: String, quality: Double): Any = js.native
    def image(target: DisplayObject, format: Unit, quality: Double): Any = js.native
    ...
    /**
      ...
      */
    def pixels(): Any = js.native
    def pixels(target: Unit, frame: PixelExtractOptions): Any = js.native
    def pixels(target: Unit, frame: Rectangle): Any = js.native
    def pixels(target: RenderTexture): Any = js.native
    def pixels(target: RenderTexture, frame: PixelExtractOptions): Any = js.native
    def pixels(target: RenderTexture, frame: Rectangle): Any = js.native
    def pixels(target: DisplayObject): Any = js.native
    def pixels(target: DisplayObject, frame: PixelExtractOptions): Any = js.native
    def pixels(target: DisplayObject, frame: Rectangle): Any = js.native
