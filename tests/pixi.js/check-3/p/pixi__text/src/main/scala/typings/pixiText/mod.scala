...
object mod {
  ...
  open class Text () extends Text2 {
    ...
    def this(text: String, style: Partial[ITextStyle]) = this()
    def this(text: Double, style: TextStyle) = this()
    def this(text: Double, style: Partial[ITextStyle]) = this()
    def this(text: Unit, style: TextStyle) = this()
    def this(text: Unit, style: Partial[ITextStyle]) = this()
    ...
    def this(text: String, style: Partial[ITextStyle], canvas: HTMLCanvasElement) = this()
    ...
    def this(text: Double, style: Partial[ITextStyle], canvas: HTMLCanvasElement) = this()
    ...
    def this(text: Unit, style: Partial[ITextStyle], canvas: HTMLCanvasElement) = this()
  }
  object Text {
  ...
  object TextMetrics {
    ...
    inline def measureText(
      ...
      style: TextStyle,
      wordWrap: Boolean,
      canvas: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify OffscreenCanvas */ Any
  ...
  open class TextStyle ()
    extends StObject
       with ITextStyle {
    def this(style: Partial[ITextStyle]) = this()
  ...
  trait ModernContext2D
    ...
    var textLetterSpacing: js.UndefOr[Double] = js.undefined
  }
  object ModernContext2D {
    
    inline def apply(): ModernContext2D = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModernContext2D]
    }
    
    extension [Self <: ModernContext2D](x: Self) {
      
      inline def setLetterSpacing(value: Double): Self = StObject.set(x, "letterSpacing", value.asInstanceOf[js.Any])
      
      inline def setLetterSpacingUndefined: Self = StObject.set(x, "letterSpacing", js.undefined)
      
      inline def setTextLetterSpacing(value: Double): Self = StObject.set(x, "textLetterSpacing", value.asInstanceOf[js.Any])
      
      inline def setTextLetterSpacingUndefined: Self = StObject.set(x, "textLetterSpacing", js.undefined)
    }
  }
  ...
  trait Text2 extends Sprite {
    ...
    /**
      ...
      */
    def style: TextStyle | Partial[ITextStyle] = js.native
    def style_=(style: TextStyle | Partial[ITextStyle]): Unit = js.native
  ...
  */
  ...
  type TextStyleFill = String | (js.Array[Double | String]) | Double | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CanvasGradient */ Any)
