...
object mod {
  ...
  open class Mesh[T /* <: Shader */] protected ()
    ...
    /**
      ...
      * @private
      */
    var uvs: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any = js.native
  ...
  open class MeshBatchUvs protected () extends StObject {
    ...
    /** UV Buffer data. */
    val data: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any = js.native
