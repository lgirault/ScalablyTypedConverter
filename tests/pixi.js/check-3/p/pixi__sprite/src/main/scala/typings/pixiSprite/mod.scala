...
object mod {
  ...
  open class Sprite ()
    extends Container[DisplayObject]
       with typings.pixiSprite.GlobalMixins.Sprite {
    ...
    var indices: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint16Array */ Any = js.native
    ...
    /**
      ...
      * @member {Float32Array}
      */
    /* protected */ var uvs: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any = js.native
    
    /**
      * This is used to store the vertex data of the sprite (basically a quad).
      * @member {Float32Array}
      */
    /* protected */ var vertexData: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any = js.native
