...
inline def getTestContext(): /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLRenderingContext */ Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getTestContext")().asInstanceOf[/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLRenderingContext */ Any]
...
type IArrayBuffer = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ArrayBuffer */ Any
...
type IRenderingContext = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGL2RenderingContext */ Any

type IResourcePluginOptions = StringDictionary[Any]

type ImageSource = (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any) | HTMLCanvasElement
