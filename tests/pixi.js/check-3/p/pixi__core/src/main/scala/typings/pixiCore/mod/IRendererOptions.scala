...
trait IRendererOptions
  ...
  var powerPreference: js.UndefOr[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLPowerPreference */ Any
  ] = js.undefined
...
object IRendererOptions {
  ...
  extension [Self <: IRendererOptions](x: Self) {
    ...
    inline def setPowerPreference(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLPowerPreference */ Any
    ): Self = StObject.set(x, "powerPreference", value.asInstanceOf[js.Any])
