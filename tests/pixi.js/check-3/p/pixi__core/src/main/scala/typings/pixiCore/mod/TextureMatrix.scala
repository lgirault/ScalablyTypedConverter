...
open class TextureMatrix protected () extends StObject {
  ...
  /**
    ...
    */
  val uClampFrame: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any = js.native
  
  /** Normalized clamp offset. Calculated based on clampOffset. */
  val uClampOffset: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any = js.native
