...
open class ContextSystem protected ()
  ...
  def createContext(
    ...
    options: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLContextAttributes */ Any
  ): IRenderingContext = js.native
  ...
  /**
    ...
    */
  /* protected */ def handleContextLost(
    event: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLContextEvent */ Any
  ): Unit = js.native
