...
object SVGResource {
  ...
  @js.native
  def SVG_SIZE: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RegExp */ Any = js.native
  inline def SVG_SIZE_=(
    x: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RegExp */ Any
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SVG_SIZE")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SVG_XML: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RegExp */ Any = js.native
  inline def SVG_XML_=(
    x: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RegExp */ Any
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SVG_XML")(x.asInstanceOf[js.Any])
