...
object Texture {
  ...
  inline def fromBuffer(
    buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8Array */ Any,
    width: Double,
    height: Double
  ): Texture[BufferResource] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromBuffer")(buffer.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[Texture[BufferResource]]
  inline def fromBuffer(
    buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8Array */ Any,
    width: Double,
    height: Double,
  ...
  inline def fromLoader[R /* <: Resource */](source: String, imageUrl: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](source: String, imageUrl: String, name: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](source: String, imageUrl: String, name: String, options: IBaseTextureOptions[Any]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](source: String, imageUrl: String, name: Unit, options: IBaseTextureOptions[Any]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  /**
    ...
    */
  inline def fromLoader[R /* <: Resource */](
    source: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any,
    imageUrl: String
  ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](
    source: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any,
    imageUrl: String,
    name: String
  ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](
    source: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any,
    imageUrl: String,
    name: String,
    options: IBaseTextureOptions[Any]
  ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](
    source: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any,
    imageUrl: String,
    name: Unit,
  ...
  inline def fromLoader[R /* <: Resource */](source: HTMLCanvasElement, imageUrl: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](source: HTMLCanvasElement, imageUrl: String, name: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](source: HTMLCanvasElement, imageUrl: String, name: String, options: IBaseTextureOptions[Any]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromLoader[R /* <: Resource */](source: HTMLCanvasElement, imageUrl: String, name: Unit, options: IBaseTextureOptions[Any]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLoader")(source.asInstanceOf[js.Any], imageUrl.asInstanceOf[js.Any], name.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  /**
    ...
    */
  inline def fromURL[R /* <: Resource */, RO](url: String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def fromURL[R /* <: Resource */, RO](url: String, options: IBaseTextureOptions[RO]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def fromURL[R /* <: Resource */, RO](url: js.Array[String]): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def fromURL[R /* <: Resource */, RO](url: js.Array[String], options: IBaseTextureOptions[RO]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fromURL")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
