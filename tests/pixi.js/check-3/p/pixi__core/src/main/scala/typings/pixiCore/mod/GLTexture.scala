...
open class GLTexture protected () extends StObject {
  def this(texture: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLTexture */ Any) = this()
  ...
  /** The WebGL texture. */
  var texture: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLTexture */ Any = js.native
