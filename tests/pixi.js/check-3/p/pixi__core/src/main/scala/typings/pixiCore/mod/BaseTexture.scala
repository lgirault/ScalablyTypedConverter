...
open class BaseTexture[R /* <: Resource */, RO] ()
  ...
  def this(resource: Any | ImageSource | R) = this()
  def this(resource: String) = this()
  def this(resource: Any | ImageSource | R, options: IBaseTextureOptions[RO]) = this()
  ...
  /**
    ...
    */
  def onError(
    event: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ErrorEvent */ Any
  ): Unit = js.native
...
object BaseTexture {
  ...
  inline def fromBuffer(
    ...
    width: Double,
    height: Double
  ): BaseTexture[BufferResource, IAutoDetectOptions] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromBuffer")(buffer.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[BaseTexture[BufferResource, IAutoDetectOptions]]
  inline def fromBuffer(
    buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint8Array */ Any,
    width: Double,
    height: Double,
