...
open class Geometry () extends StObject {
  ...
  def addAttribute(
    id: String,
    buffer: Buffer2 | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any) | js.Array[Double],
  ...
  def addIndex(buffer: IArrayBuffer): Geometry = js.native
  ...
  /**
    ...
    * @type {object}
    */
  var glVertexArrayObjects: NumberDictionary[
    StringDictionary[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLVertexArrayObject */ Any
    ]
  ] = js.native
