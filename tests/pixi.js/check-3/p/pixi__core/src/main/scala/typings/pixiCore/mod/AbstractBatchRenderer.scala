...
open class AbstractBatchRenderer protected () extends ObjectRenderer {
  ...
  /**
    ...
    */
  /* protected */ var _iBuffers: js.Array[
  ...
  /* protected */ var _indexBuffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint16Array */ Any = js.native
  ...
  /**
    ...
    */
  def getIndexBuffer(size: Double): Any = js.native
  ...
  def packInterleavedGeometry(
    ...
    indexBuffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Uint16Array */ Any,
    aIndex: Double,
    iIndex: Double
  ): Unit = js.native
