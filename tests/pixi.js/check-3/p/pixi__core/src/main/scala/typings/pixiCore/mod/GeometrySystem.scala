...
open class GeometrySystem protected ()
  ...
  /* protected */ var _activeVao: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebGLVertexArrayObject */ Any = js.native
  ...
  /**
    ...
    */
  /* protected */ def initGeometryVao(geometry: Geometry, shader: Shader): Any = js.native
  /* protected */ def initGeometryVao(geometry: Geometry, shader: Shader, incRefCount: Boolean): Any = js.native
