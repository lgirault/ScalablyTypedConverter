...
open class ImageResource protected () extends BaseImageResource {
  ...
  /**
    ...
    */
  def this(source: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLImageElement */ Any) = this()
  ...
  /**
    ...
    * @default null
    */
  var bitmap: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ImageBitmap */ Any = js.native
  ...
  def load(createBitmap: Boolean): Any = js.native
