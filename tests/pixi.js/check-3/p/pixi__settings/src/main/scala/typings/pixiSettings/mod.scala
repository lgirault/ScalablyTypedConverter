...
object mod {
  ...
  */
  ...
  trait IAdapter extends StObject {
    ...
    def fetch(
      url: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestInfo */ Any
    ): Any = js.native
    def fetch(
      url: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestInfo */ Any,
      options: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestInit */ Any
    ): Any = js.native
    ...
    def getWebGLRenderingContext(): Any = js.native
  }
  ...
  trait ISettings extends StObject {
    ...
    var RETINA_PREFIX: js.UndefOr[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RegExp */ Any
      ] = js.undefined
  ...
  object ISettings {
    ...
    extension [Self <: ISettings](x: Self) {
      ...
      inline def setRETINA_PREFIX(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RegExp */ Any
      ): Self = StObject.set(x, "RETINA_PREFIX", value.asInstanceOf[js.Any])
