...
object mod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HTMLElement * / any */ trait IAccessibleHTMLElement extends StObject {
    
    var displayObject: js.UndefOr[DisplayObject] = js.undefined
    
    var `type`: js.UndefOr[String] = js.undefined
  }
  object IAccessibleHTMLElement {
    
    inline def apply(): IAccessibleHTMLElement = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IAccessibleHTMLElement]
    }
    
    extension [Self <: IAccessibleHTMLElement](x: Self) {
      
      inline def setDisplayObject(value: DisplayObject): Self = StObject.set(x, "displayObject", value.asInstanceOf[js.Any])
      
      inline def setDisplayObjectUndefined: Self = StObject.set(x, "displayObject", js.undefined)
