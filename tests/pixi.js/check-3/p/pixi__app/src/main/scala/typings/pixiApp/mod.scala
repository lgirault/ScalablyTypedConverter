...
object mod {
  ...
  open class Application ()
    ...
    /* CompleteClass */
    var resizeTo: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Window */ Any = js.native
  ...
  object ResizePlugin {
    ...
    @js.native
    def resizeTo: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Window */ Any = js.native
    inline def resizeTo_=(
      x: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Window */ Any
    ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("resizeTo")(x.asInstanceOf[js.Any])
  }
  ...
  type ResizeableRenderer = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Pick<Renderer, 'resize'> */ Any
}
