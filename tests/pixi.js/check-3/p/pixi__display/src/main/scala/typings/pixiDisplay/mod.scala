...
object mod {
  ...
  open class Bounds () extends StObject {
    ...
    /**
      ...
      */
    def addQuad(
      vertices: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any
    ): Unit = js.native
  ...
  @js.native
  open class Container[T /* <: DisplayObject */] ()
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Omit<GlobalMixins.DisplayObject, keyof EventEmitter> * / any */ @JSImport("@pixi/display", "DisplayObject")
  @js.native
