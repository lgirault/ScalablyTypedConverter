...
object mod {
  ...
  open class Matrix protected () extends StObject {
    ...
    var array: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Float32Array */ Any) | Null = js.native
    ...
    /**
      ...
      */
    def toArray(transpose: Boolean): Any = js.native
    def toArray(
      transpose: Boolean,
